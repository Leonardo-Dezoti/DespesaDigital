      ...
      actions: <Widget>[
        TextButton(
          onPressed: () async {
            ...
            // Verifica se o valor está vazio e a descrição foi inserida
            ...
            // Verifica se a descrição está vazia e o valor foi inserido
            ...
            try {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Erro ao adicionar a movimentação. Verifique os valores inseridos.')),
              );
      ...
      actions: <Widget>[
        TextButton(
          onPressed: () async {
            ...
            if (meta_id == null && valorTexto.isEmpty) {
              ScaffoldMessenger.of(context).showSnackBar(
            ...
            // Verifica se o usuário não selecionou uma meta
            if (meta_id == null) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Por favor, selecione uma meta.')),
              );
              return;
            }
            ...
            try {
              ...
              print('Erro ao guardar o saldo: $e');
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Erro ao guardar o saldo. Verifique os valores inseridos.')),
              );
            }
          },
          child: Text('Guardar'),
  ...
  Future<void> _fetchContas() async {
    ...
    setState(() {
      ...
      if (_contas.isNotEmpty) {
        ...
        // Converter o valor da conta para string com 2 casas decimais antes de formatar
        String valorFormatado = _selectedConta!.valor.toStringAsFixed(2);

        // Aplica a formatação de moeda ao valor da conta
        _valorController.text = MoedaTextInputFormatter().formatEditUpdate(
          TextEditingValue(text: ''), // Valor inicial
          TextEditingValue(text: valorFormatado), // Valor formatado corretamente
        ).text;
      }
    });
  }
              ...
              onChanged: (Conta? newConta) {
                setState(() {
                  ...
                  if (_selectedConta != null) {
                    // Converter o valor da nova conta selecionada para string com 2 casas decimais
                    String valorFormatado = _selectedConta!.valor.toStringAsFixed(2);

                    // Formatar o valor da conta para exibição
                    _valorController.text = MoedaTextInputFormatter().formatEditUpdate(
      ...
      actions: <Widget>[
        TextButton(
          onPressed: () async {
            ...
            // Verificação de conta e valor
            if (conta_id == null && valorTexto.isEmpty) {
              ScaffoldMessenger.of(context).showSnackBar(
            ...
            // Verifica se o usuário não selecionou uma conta
            if (conta_id == null) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Por favor, selecione uma conta.')),
              );
              return;
            }
            ...
            try {
              ...
              bool isPaid = await ContaDB().isPaymentMadeThisMonth(conta_id);
      ...
      actions: <Widget>[
        TextButton(
          onPressed: () async {
            ...
            if (divida_id == null) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Por favor, selecione uma dívida.')),
              );
              return;
            }
            ...
            try {
              await MovimentacaoDB().create4(
                data: DateFormat('yyyy-MM-dd').format(_dataLimite),
                valor: valor, // Como não há valor, podemos definir como zero
                categoria: categoria,
              ...
              print('Erro ao pagar a divida: $e');
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Erro ao pagar a divida. Verifique os valores inseridos.')),
              );
            }
          },
          child: Text('Pagar'),
